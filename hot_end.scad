...
translate([7,0,0])translate([-19.5,0,15])rotate([90,0,90])linear_extrude(3.2)projection()fan_no_center();
translate([-3.2,0,0])translate([-19.5,0,15])rotate([90,0,90])color([.3,.3,.3,.3])fan_30mm();
